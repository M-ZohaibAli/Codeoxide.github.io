...
var questions = [
  {
    prompt: "The maximum optimum temperature for growth of plants is",
    options: ["10-20 degree C>", "30-40 degree C", "20-40 degree C", "25-30 degree C"],
    answer: "25-30 degree C"
  },

  {
    prompt: "During cell differentiation",
    options: ["Both of these", "None of these", "Walls of cells become thick", "Walls of cells become pitted"],
    answer: "Both of these"
  },
  {
    prompt: "Which one is incorrect",
    options: ["Red light favors elongation of cells", "UV rays retard cell division", "Blue light retards cell enlargement", "UV rays retard cell elongation"],
